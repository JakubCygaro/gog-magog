...
use crate::webworks::WebworksResult;
...
async fn test_loader(v: i32) -> Result<Vec<PostData>, WebworksError> {
...
pub fn UserPosts() -> impl IntoView {
    ...
    view!{
        <InfiniteLoad loader=test_loader display=dis/>
    }
}

#[component]
pub fn InfiniteLoad<T, L, D, IV, E, F>(
    #[prop(default = LOAD_MORE_AMOUNT)]
    load_more: i32, 
    #[prop(default = LOAD_INITIAL)]
    load_initial: i32, 
